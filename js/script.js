...
const startGameFunc = () => {
    if (!gameState.taskInProcess) {
        ...
        title.innerText = "You " + ((isRight) ? "won!" : "lose :(")
    }
    toggleGameState()
    btnGame.innerText = (gameState.taskInProcess) ? "Check anwser!" : "Play again!"
}
...
function addPost(title, body) {
    const postContainer = document.querySelector(".post_block_container")
    ...
    postsBlog = postContainer.append(postItem)
}
